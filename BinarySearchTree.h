...
// int totalRecursiveCalls ( x ) --> Returns the amount of recursive calls to find x in the tree.
// ******************ERRORS********************************
...
public:
  ...
  {
    Comparable tmp{n};
    return 1 + totalRecursiveCalls(root, tmp); //The additional 1 is the original call
  }
...
private:
  ...
  /**
    *Internal method to find and return a node
    */
  ...
  //Finds the sum of the depths of all nodes in the tree
  ...
  int totalRecursiveCalls(BinaryNode *t, const Comparable &n)
  {
    ...
    else
    {
      ...
      { //you found your item, no more calls
        return 0;
      }
    }
  }
